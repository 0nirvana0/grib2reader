...
import ucar.nc2.grib.GribTables.Parameter;
import ucar.nc2.grib.VertCoord.VertUnit;
...
public class Grib2Test {
	...
	public static void main(String[] args) {
		String path = "resource/rap-native.grib2";
		TestReadGrab2(path);
	}
	...
	public static void TestReadGrab2(String path) {
		...
		try {
			...
			int dateTemplate=	drs.getDataTemplate();
				...
				section5.append("DataTemplate : ").append(dateTemplate);
